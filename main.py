...
b_calcular = Button(frame_baixo, command=calcular, text='Calcular', width=37, height=1, overrelief=SOLID, relief='raised',anchor='center',font=('Ivy 10 bold'), bg=co2, fg=co0)
