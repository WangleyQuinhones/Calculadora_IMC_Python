...
def calcular():
  ...
  if resultado < 18.5:
    ...
    l_resultado_texto['text'] = "Seu IMC está: No peso ideal!",

  elif resultado >= 25 and resultado < 30:
    l_resultado_texto['text'] = "Seu IMC está: Acima do peso!",

  else:
    l_resultado_texto['text'] = "Seu IMC está: Obesidade!",
...
l_resultado_texto = Label(frame_baixo, text='', width=37, height=1, padx=0, pady=12, relief='flat',anchor='center',
                font=('Ivy 10 bold'), bg=co0, fg=co1)
l_resultado_texto.place(x=0, y=90)

b_calcular = Button(frame_baixo, command=calcular, text='Calcular', width=37, height=1, overrelief=SOLID, relief='raised',anchor='center',
